...
public class TestNG_Example {
    ...
    /*
    dependsOn Methods used when following @Test is dependent on previous @Test method. If the first test fails,
    ...
    */
    ...
    public void CaptureSearchNumber() {
        ...
        String result = Reusable_Actions.getTextAction(driver,"//*[@id='result-stats']","Search Results Text");
